                ...
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full lg:w-7/12 text-center lg:text-left">
                        <div className="space-y-6">
                            ...
                            <h2 className="text-4xl md:text-6xl xl:text-7xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-500 bg-clip-text text-transparent leading-tight">For the Quality of work delivered</h2>
